...
<div class="container mx-auto px-4">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('role-permission-ui.roles.store') }}" method="POST">
            @csrf
            <div class="space-y-6">
                <div>
            ...
            <div class="mt-6 flex items-center justify-between">
                <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Save Role</button>
